...
function DuelFighter({
  ...
  return (
    <Link
      ...
      className={`group flex min-w-0 flex-1 items-center gap-3 active:opacity-90 ${align === "right" ? "flex-row-reverse text-right" : ""}`}
    >
      <div
        className="h-16 w-16 shrink-0 border border-white/15 bg-cover bg-center transition group-active:border-[#00f3ff]/50"
        style={
          thumb
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-1 truncate text-[15px] font-semibold text-white">{side.displayName}</div>
        <div className="mt-2">
      ...
      <div
        className="shrink-0 font-mono text-[36px] font-black leading-none text-white"
...
export function ScoreDuel({ duel }: { duel: WeeklyScoreDuel }) {
  return (
    <section className="score-duel relative overflow-hidden border border-white/10 bg-black/40 px-4 py-5 backdrop-blur-sm animate-[duelIn_0.75s_ease-out_0.12s_both]">
      ...
      <div className="flex flex-col items-stretch gap-4">
        ...
        <div className="text-center text-[13px] font-black tracking-[0.3em] text-white/25">VS</div>
