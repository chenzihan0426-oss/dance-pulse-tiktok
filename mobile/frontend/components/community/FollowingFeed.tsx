        ...
        <div className="divide-y divide-white/8 border border-white/10 bg-black/35">
          {friendPulse.map((item) => (
            <Link
              ...
              className="block px-4 py-4 transition active:bg-white/[0.06]"
            >
              <div className="flex items-center gap-2">
                <div className="flex h-10 w-10 items-center justify-center bg-white/10 text-[13px] font-bold">
          ...
          {friendWorks.map((item) => {
            ...
            return (
              <Link
                ...
                className="flex gap-3 border border-white/10 bg-black/40 p-2 transition active:border-white/20"
              >
                <div
                  className="h-28 w-[72px] shrink-0 bg-cover bg-center"
                  style={
                    thumb
                ...
                <div className="min-w-0 flex-1 py-1">
                  ...
                  <div className="mt-1 line-clamp-1 text-[15px] font-semibold text-white">{item.lessonTitle}</div>
                  {meta?.caption ? (
