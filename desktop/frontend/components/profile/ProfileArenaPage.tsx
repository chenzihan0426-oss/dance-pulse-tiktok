...
export function ProfileArenaPage({
  ...
  return (
    <main className="relative mx-auto min-h-screen max-w-[1100px] pb-16 text-white">
      ...
      <section className="mt-8 space-y-5 px-5 md:px-8">
        ...
        <Link
          href={isOwn ? "/premium" : "/learn"}
          className="relative block overflow-hidden border border-[#ccff00]/30 bg-[linear-gradient(110deg,rgba(204,255,0,0.14),rgba(5,5,5,0.92)_55%)] px-5 py-4 transition hover:border-[#ccff00]/55"
        >
